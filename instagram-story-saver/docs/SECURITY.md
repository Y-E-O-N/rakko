...
Instagram Story Saver는 민감한 인증 정보를 다루므로 보안에 주의가 필요합니다.
...
EnvironmentFile=/etc/instagram-story-saver/env
```
...
```yaml
monitor:
  check_interval: 1800  # 30분 (최소 300초)
  batch_size: 20        # 한 번에 체크할 유저 수
  batch_delay: 5        # 배치 간 대기 시간
```
